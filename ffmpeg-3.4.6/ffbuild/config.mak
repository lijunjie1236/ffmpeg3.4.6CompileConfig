...
FFMPEG_CONFIG_MAK=1
FFMPEG_CONFIGURATION=--prefix='F:/FFmpeg/output/arm' --disable-static --enable-shared --enable-small --enable-runtime-cpudetect --disable-programs --disable-ffmpeg --disable-ffplay --disable-ffprobe --disable-ffserver --disable-doc --enable-pthreads --disable-decoders --enable-decoder=h264_mediacodec --disable-encoders --disable-hwaccels --enable-hwaccel=h264_mediacodec --disable-parsers --enable-parser=h264 --disable-demuxers --disable-muxers --disable-protocols --disable-filters --disable-bsfs --disable-indevs --disable-outdevs --disable-v4l2_m2m --enable-jni --enable-mediacodec --arch=arm --cross-prefix='F:/ndk/android-ndk-r14b/toolchains/arm-linux-androideabi-4.9/prebuilt/windows-x86_64/bin/arm-linux-androideabi-' --enable-cross-compile --sysroot='F:/ndk/android-ndk-r14b/platforms/android-14/arch-arm' --target-os=android --disable-symver --enable-asm --enable-neon --extra-cflags='-fdata-sections -ffunction-sections -fstack-protector-strong -ffast-math -fstrict-aliasing -marm -march=armv6 -isystem F:/ndk/android-ndk-r14b/sysroot/usr/include -isystem F:/ndk/android-ndk-r14b/sysroot/usr/include/arm-linux-androideabi' --extra-ldflags='-Wl,--gc-sections -Wl,-z,relro -Wl,-z,now'
prefix=F:/FFmpeg/output/arm
...
ARCH=arm
INTRINSICS=none
CC=F:/ndk/android-ndk-r14b/toolchains/arm-linux-androideabi-4.9/prebuilt/windows-x86_64/bin/arm-linux-androideabi-gcc
CXX=F:/ndk/android-ndk-r14b/toolchains/arm-linux-androideabi-4.9/prebuilt/windows-x86_64/bin/arm-linux-androideabi-g++
AS=F:/ndk/android-ndk-r14b/toolchains/arm-linux-androideabi-4.9/prebuilt/windows-x86_64/bin/arm-linux-androideabi-gcc
OBJCC=F:/ndk/android-ndk-r14b/toolchains/arm-linux-androideabi-4.9/prebuilt/windows-x86_64/bin/arm-linux-androideabi-gcc
LD=F:/ndk/android-ndk-r14b/toolchains/arm-linux-androideabi-4.9/prebuilt/windows-x86_64/bin/arm-linux-androideabi-gcc
DEPCC=F:/ndk/android-ndk-r14b/toolchains/arm-linux-androideabi-4.9/prebuilt/windows-x86_64/bin/arm-linux-androideabi-gcc
DEPCCFLAGS= $(CPPFLAGS)
DEPAS=F:/ndk/android-ndk-r14b/toolchains/arm-linux-androideabi-4.9/prebuilt/windows-x86_64/bin/arm-linux-androideabi-gcc
DEPASFLAGS= $(CPPFLAGS)
X86ASM=nasm
DEPX86ASM=nasm
DEPX86ASMFLAGS=$(X86ASMFLAGS)
AR=F:/ndk/android-ndk-r14b/toolchains/arm-linux-androideabi-4.9/prebuilt/windows-x86_64/bin/arm-linux-androideabi-ar
ARFLAGS=rcD
AR_O=$@
RANLIB=F:/ndk/android-ndk-r14b/toolchains/arm-linux-androideabi-4.9/prebuilt/windows-x86_64/bin/arm-linux-androideabi-ranlib -D
STRIP=F:/ndk/android-ndk-r14b/toolchains/arm-linux-androideabi-4.9/prebuilt/windows-x86_64/bin/arm-linux-androideabi-strip
STRIPTYPE=direct
NVCC=nvcc
CP=cp -p
LN_S=ln -s -f
CPPFLAGS= --sysroot=F:/ndk/android-ndk-r14b/platforms/android-14/arch-arm -isysroot F:/ndk/android-ndk-r14b/platforms/android-14/arch-arm -D_ISOC99_SOURCE -D_FILE_OFFSET_BITS=64 -D_LARGEFILE_SOURCE -Dstrtod=avpriv_strtod -DPIC -DZLIB_CONST
CFLAGS=  -fdata-sections -ffunction-sections -fstack-protector-strong -ffast-math -fstrict-aliasing -marm -march=armv6 -isystem F:/ndk/android-ndk-r14b/sysroot/usr/include -isystem F:/ndk/android-ndk-r14b/sysroot/usr/include/arm-linux-androideabi -march=armv6 -std=c11 -fomit-frame-pointer -fPIC -marm -pthread -g -Wdeclaration-after-statement -Wall -Wdisabled-optimization -Wpointer-arith -Wredundant-decls -Wwrite-strings -Wtype-limits -Wundef -Wmissing-prototypes -Wno-pointer-to-int-cast -Wstrict-prototypes -Wempty-body -Wno-parentheses -Wno-switch -Wno-format-zero-length -Wno-pointer-sign -Os -fno-math-errno -fno-signed-zeros -fno-tree-vectorize -Werror=format-security -Werror=implicit-function-declaration -Werror=missing-prototypes -Werror=return-type -Werror=vla -Wformat -fdiagnostics-color=auto -Wno-maybe-uninitialized
CXXFLAGS=  -D__STDC_CONSTANT_MACROS -std=c++11
OBJCFLAGS=  
ASFLAGS=  -fdata-sections -ffunction-sections -fstack-protector-strong -ffast-math -fstrict-aliasing -marm -march=armv6 -isystem F:/ndk/android-ndk-r14b/sysroot/usr/include -isystem F:/ndk/android-ndk-r14b/sysroot/usr/include/arm-linux-androideabi -march=armv6 -fPIC -g
...
LD_PATH=-L
DLLTOOL=
WINDRES=F:/ndk/android-ndk-r14b/toolchains/arm-linux-androideabi-4.9/prebuilt/windows-x86_64/bin/arm-linux-androideabi-windres
DEPWINDRES=F:/ndk/android-ndk-r14b/toolchains/arm-linux-androideabi-4.9/prebuilt/windows-x86_64/bin/arm-linux-androideabi-gcc
DOXYGEN=doxygen
LDFLAGS= -Wl,--gc-sections -Wl,-z,relro -Wl,-z,now  --sysroot=F:/ndk/android-ndk-r14b/platforms/android-14/arch-arm -isysroot F:/ndk/android-ndk-r14b/platforms/android-14/arch-arm -march=armv6 -Wl,--as-needed -Wl,-z,noexecstack -Wl,--warn-common -Wl,-rpath-link=libpostproc:libswresample:libswscale:libavfilter:libavdevice:libavformat:libavcodec:libavutil:libavresample
LDEXEFLAGS=
LDLIBFLAGS=
